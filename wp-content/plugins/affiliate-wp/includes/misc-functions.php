 ...
 *
 * @since 1.0
 * @since 2.6.3 The optional `$decimals` parameter was added.
 *
 * @param string $amount   Amount amount to format.
 * @param bool   $decimals Optional. Whether to sanitize the amount with decimals. Default true.
 * @return string $amount Newly sanitized amount
 */
function affwp_sanitize_amount( $amount, $decimals = true ) {
	...
	// By this point, decimal separator has been normalized to a period for storage.
