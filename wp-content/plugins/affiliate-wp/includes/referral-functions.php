 ...
 *
 * Converts given rates to use period decimal separators (if present) and strip any
 * non-float characters prior to storage.
 *
 * @since 2.2.11
 * @since 2.6.3  Converted to wrap affwp_sanitize_amount() with `$force_decimals` set to false.
 *
...
function affwp_sanitize_referral_rate( $rate ) {
	return affwp_sanitize_amount( $rate, false );
}