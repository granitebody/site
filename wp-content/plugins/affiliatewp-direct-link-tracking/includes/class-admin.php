	...
	public function register_settings( $settings = array() ) {
		...
		$settings['direct-link-tracking'] = array(
			...
			'direct_link_tracking_notify_admin' => array(
				'name' => __( 'Notify Affiliate Manager', 'affiliatewp-direct-link-tracking' ),
				'desc' => __( 'Notify affiliate manager when a direct link has been submitted for approval.', 'affiliatewp-direct-link-tracking' ),
				'type' => 'checkbox'
			),
			...
			'direct_link_tracking_url_blacklist' => array(
				...
				'desc' => __( 'Domains placed here will be blocked from being added (by affiliate manager or affiliate) and prevent a visit from being created if already in use. Enter one domain per line.', 'affiliatewp-direct-link-tracking' ),
				'type' => 'textarea',
