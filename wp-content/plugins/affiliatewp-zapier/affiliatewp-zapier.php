 ...
 * @since 1.1.2
 */
function affiliatewp_zapier_install() {
...
register_activation_hook( __FILE__, 'affiliatewp_zapier_install' );
 ...
 * @since 1.1.2
 */
function affiliatewp_zapier_plugin_deactivation() {
	affiliatewp_zapier()->clear_scheduled_event();
}
register_deactivation_hook( __FILE__, 'affiliatewp_zapier_plugin_deactivation' );
 ...
 * @since 1.1.2
 */
function affiliatewp_zapier_check_if_installed() {

	if ( ! get_option( 'affwp_zapier_is_installed' ) ) {
		affiliatewp_zapier_install();
	}
}
add_action( 'admin_init', 'affiliatewp_zapier_check_if_installed' );
