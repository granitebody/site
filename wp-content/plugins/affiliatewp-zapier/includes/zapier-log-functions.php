...
function affwp_zapier_post_update_affiliate( $data, $row_id ) {
	...
	$meta = array(
		...
		'first_name'       => affwp_get_affiliate_first_name( $affiliate_id ),
		'last_name'        => affwp_get_affiliate_last_name( $affiliate_id ),
...
function affwp_zapier_post_update_referral( $object, $object_id ) {
	...
	$meta = array(
		...
		'affiliate_name'  => affwp_get_affiliate_name( $referral->affiliate_id ),
