...
class Cornerstone_Conditionals extends Cornerstone_Plugin_Component {
    ...
    if (! isset( $this->condition_contexts ) ) {
      $this->condition_contexts = apply_filters('cs_condition_contexts', [
        'labels' => [
          ...
          'current-query'   => __('Current Query', 'cornerstone'),
        ...
        'controls' => [
          ...
          'global'        => $this->assignment_context_global()
        ]
      ]);
    }
  ...
  public function assignment_context_archive() {
    ...
    $conditions = [
      [
        ...
        'key'   => 'archive:query-type',
        'label' => __('Query Condition', 'cornerstone'),
        'toggle' => ['type' => 'boolean'],
        'criteria' => [
          'type'    => 'select',
          'choices' => [
            ['value' => 'date', 'label' => __('Date Archive', 'cornerstone')],
            ['value' => 'first-page', 'label' => __('First Page', 'cornerstone')]
          ]
        ]
      ], [
        'key'   => 'archive:post-type',
  ...
  public function assignment_context_global() {
    return [
      [
        'key'    => 'global:today',
        ...
        'label'  => __('Current User', 'cornerstone'),
        'toggle' => [
          'type'   => 'boolean',
          'labels' => [
  ...
  public function condition_context_looper() {
    return [
      [
        ...
        'label' => __('Consumed Item', 'cornerstone'),
        'toggle' => [
          'type'   => 'boolean',
          'labels' => [
