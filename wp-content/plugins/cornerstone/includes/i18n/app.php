...
return array(
  ...
  'download.entity'                               => __( 'Download {{context}}', 'cornerstone'),
  'download.entity-count'                         => __( 'Download {{count}} {{context}}', 'cornerstone'),
  'delete.entity'                                 => __( 'Delete {{context}}', 'cornerstone'),
  'delete.entity-count'                           => __( 'Delete {{count}} {{context}}', 'cornerstone'),
  ...
  'design-cloud.how.one'                          => __( 'Our team of designers create beautiful premium templates.', 'cornerstone' ),
  'design-cloud.how.two'                          => __( 'They are added to Design Cloud and show up automagically.', 'cornerstone' ),
  'design-cloud.how.three'                        => __( 'Demo and install directly to your Template Manager.', 'cornerstone' ),
  ...
  'code-editors.css_placeholder_global'           => __( "/*\nEnter any CSS you would like added site wide; No style tags required;\nsimply get started by writing\nCSS! Watch as your changes\nare reflected live in the\npreview area. Have fun!\n*/\n\n", 'cornerstone' ),
