...
$atts = array(
  'class' => x_attr_class( array( $style_id, 'x-countdown', 'has-' . $countdown_labels_output . '-labels', $class ) )
);
...
if ( $timestamp_diff <= 0 ) {
  $complete_content .= '<div class="x-countdown-complete">' . do_shortcode( $countdown_complete_content ) . '</div>';
}
