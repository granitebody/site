...
$classes_off_canvas         = x_attr_class( array( $style_id, 'x-off-canvas', 'x-off-canvas-' . $off_canvas_location, $class ) );
...
if (isset($off_canvas_content_dynamic_rendering) && $off_canvas_content_dynamic_rendering) {
  ...
  $atts_off_canvas_content['data-x-toggleable-content'] = $unique_id;
}
