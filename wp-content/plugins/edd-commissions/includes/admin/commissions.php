				...
				<table class="widefat striped">
					<tbody>
						...
						<tr>
							...
							<td style="word-wrap: break-word">
								<?php echo $commission->payment_id ? '<a href="' . esc_url( admin_url( 'edit.php?post_type=download&page=edd-payment-history&view=view-order-details&id=' . $commission->payment_id ) ) . '" title="' . __( 'View payment details', 'eddc' ) . '">#' . $commission->payment_id . '</a> - ' . edd_get_payment_status( get_post( $commission->payment_id ), true  ) : '&mdash;'; ?>
							</td>
						</tr>
						<tr>
							<td class="row-title">
