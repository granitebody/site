		...
		<?php
			...
			<div <?php echo $class_list; ?>>
				...
				<?php while ( $downloads->have_posts() ) : $downloads->the_post(); ?>
					<div itemscope itemtype="http://schema.org/Product" class="<?php echo esc_attr( apply_filters( 'edd_download_class', 'edd_download', get_the_ID(), array(), false ) ); ?>" id="edd_download_<?php echo absint( get_the_ID() ); ?>">
