...
class EDD_MailChimp_Database {
	...
	public static function update_tables() {
		...
		sync_status varchar(100) NOT NULL DEFAULT "",
		...
		id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
		list_id bigint(20) unsigned NOT NULL,
		interest_category_remote_id varchar(100) NOT NULL DEFAULT "",
		interest_category_name varchar(100) NOT NULL DEFAULT "",
		interest_remote_id varchar(100) NOT NULL DEFAULT "",
