...
final class EDD_PDF_Invoices {
	...
	*/
	...
	function purchase_history_link( $post_id, $purchase_data ) {
		...
		echo '<td class="edd_invoice"><a class="edd_invoice_link" title="' . __( 'Download Invoice', 'eddpdfi' ) . '" href="' . esc_url( edd_pdf_invoices()->get_pdf_invoice_url( $post_id ) ) . '">' . __( 'Download Invoice', 'eddpdfi' ). '</a></td>';
	}
