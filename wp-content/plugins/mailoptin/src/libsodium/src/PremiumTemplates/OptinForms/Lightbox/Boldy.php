...
HTML;
    ...
    color:#ffffff;
       ...
       html div#$optin_uuid div#$optin_css_id.boldy_container .boldy_main .boldy_note{
        ...
        html div#$optin_uuid div#$optin_css_id.boldy_container input.boldy_input:not([type="radio"]):not([type="checkbox"]),
        html div#$optin_uuid div#$optin_css_id.boldy_container select.boldy_input {
            width: 100%;
            padding: 10px;
            margin-bottom: 10px;
            border-radius: 3px;
        ...
        html div#$optin_uuid div#$optin_css_id.boldy_container.mo-has-email input.boldy_input:not([type="radio"]):not([type="checkbox"]) {
            width: 100% !important;
        }
       ...
       html div#$optin_uuid div#$optin_css_id.boldy_container .boldy_featureImage.boldy_isresponsive img {
        ...
        html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id.boldy_container .mo-optin-form-custom-field.radio-field,
        html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id.boldy_container .mo-optin-form-custom-field.checkbox-field {
            text-align: left;
            display: block;
            padding: 10px;
        ...
        html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id.boldy_container .mo-optin-form-custom-field.radio-field label,
        html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id.boldy_container .mo-optin-form-custom-field.checkbox-field label {
            text-align: left;
            display: block;
        }
