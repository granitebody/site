...
html div#$optin_uuid div#$optin_css_id.letterBox_container .mo-optin-form-custom-field.radio-field,
html div#$optin_uuid div#$optin_css_id.letterBox_container .mo-optin-form-custom-field.checkbox-field {
    background-color: #fff;
}

html div#$optin_uuid div#$optin_css_id.letterBox_container .mo-optin-form-custom-field.radio-field input,
html div#$optin_uuid div#$optin_css_id.letterBox_container .mo-optin-form-custom-field.checkbox-field input {
    margin-right: 6px;
}
CSS;
